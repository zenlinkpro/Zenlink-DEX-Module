...
pub trait StableAmmApi<BlockHash, CurrencyId, Balance, AccountId, PoolId> {
	...
	#[method(name = "stableAmm_calculateSwap")]
	fn calculate_swap(
		&self,
		pool_id: PoolId,
		in_index: u32,
	...
	#[method(name = "stableAmm_calculateRemoveLiquidity")]
